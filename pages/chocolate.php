...
<body class="body">
    ...
    <div id="main">
        ...
        <div class="map_div" style="position: relative;">
            ...
            <!-- values -->
            <img class="applicationLogo" src="../images/meter4.png" width="100px" style=" position: absolute;left:500px; top:370px;">
            <div style="position:absolute; top:470px; left:490px;color:black;width:200px">
            ...
            <div style="position:absolute; top:471px; left:620px;color:#0000FF;width:180px">
