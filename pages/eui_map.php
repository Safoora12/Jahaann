            ...
            <h2 class="h2">Energy Usage Intensity Map By Region</h2>
               ...
               <!-- CERAMIC INDUSTRY -->
                <div style="font-weight: 500 ">
                    <p style="color:#0000FF; position:absolute; top: 627px; left: 822px; font-size:14px; width:100px">50 MW</p>
                </div>
                ...
                <div style="font-weight: 500">
                    ...
                    <p style="color:#0000FF; position:absolute; top: 594px;  left: 273px; font-size:14px; width:100px">45 MW</p>
                </div>

                <!-- tEXTILE pLANT -->
                <div style="font-weight: 500">
                    <p style="color:#0000FF; position:absolute; top: 345px; left: 954px; font-size:14px; width:100px">100 MW</p>
                </div>
         
                <!-- PAPER MILL -->
                <div style="font-weight: 500">
                    <p id="result2" style="color:#0000FF; position:absolute; top: 292px; left: 987px; font-size:14px; width:100px">92 MW
                    </p>
                </div>
                ...
                <div style="font-weight: 500">
                    ...
                    <p style="color:#0000FF; position:absolute; top: 409px; left: 931px; font-size:14px; width:100px">50 MW</p>
                </div>

                <!-- sOLAR pLANT-->
                <div style="font-weight: 500">
                    <p id="result3" style="color:#0000FF; position:absolute; top: 502px; left: 847px; font-size:14px; width:100px">48 MW
                    </p>
                </div>

                <!-- SUGAR MILL -->
                <div style="font-weight: 500">
                    <p style="color:#0000FF; position:absolute;  top: 114px; left: 476px; font-size:14px; width:100px">16 MW</p>
                    </div>
                <!-- SHOPPING MALL -->
                <div style="font-weight: 500">
                    <p id="result4" style="color:#0000FF; position:absolute;top: 250px;   left: 476px; font-size:14px; width:100px">48 MW
                    </p>
                </div>
                ...
                <!-- power plant -->
                <div style="font-weight: 500">
                    <p style="color:#0000FF; position:absolute; top: 236px; left: 992px; font-size:14px; width:100px">28 MW</p>
                    </div>
           

                <div style="font-weight: 500">
                    <p id="result5" style="color:#0000FF; position:absolute; top:112px; left: 1129px; font-size:14px; width:100px">48 MW
                    </p>
                </div>
