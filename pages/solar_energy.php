...
<body class="body">
    ...
    <div id="main">
        ...
        <div class="map_div" style="position: relative;">
            ...
            <img class="applicationLogo" src="../images/meter.jpg" style="position: absolute;left:600px; top:50px">
            <div style="position:absolute; top:73px; left:860px;color:#0000FF;width:80px">
