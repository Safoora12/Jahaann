...
<body class="body">
    ...
    <div id="main">
        ...
        <div class="map_div" style="position: relative;">
            ...
            <img class="applicationLogo" src="../images/TEXTILEF.png" >
            <!-- values -->
            <img class="applicationLogo" src="../images/meter4.png" width="100px" style=" position: absolute; left: 1195px; top: 306px;">
            <div style="position:absolute; top: 415px; left: 1172px; color:black;width:200px">
            ...
            <div style="position:absolute; top: 417px; left: 1287px; color:#0000FF;width:180px">
