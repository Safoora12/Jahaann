...
<div style="font-weight: 500">
            ...
            <div style="font-weight: 500;">
                ...
                <p id="result" style="color:#0000FF; position:absolute; top:660px; left:1010px; font-size:14px; width:100px">48 MW</p>
            </div>
            <!-- wind -->
            <div style="font-weight: 500">
            ...
            <div style="font-weight: 500;">
                ...
                <p id="result1" style="color:#0000FF; position:absolute; top:737px; left:348px; font-size:14px; width:100px">48 MW</p>
            </div>
            <!-- beverages -->
            <div style="font-weight: 500">
            ...
            <div style="font-weight: 500;">
                ...
                <p id="result2" style="color:#0000FF; position:absolute; top:373px; left:1035px; font-size:14px; width:100px">92 MW</p>
            </div>
            <!-- paper -->
            <div style="font-weight: 500">
            ...
            <div style="font-weight: 500;">
                ...
                <p id="result3" style="color:#0000FF; position:absolute; top:467px; left:955px; font-size:14px; width:100px">48 MW</p>
            </div>
             <!-- power plant -->
             <div style="font-weight: 500">
            ...
            <div style="font-weight: 500;">
                ...
                <p id="result4" style="color:#0000FF; position:absolute; top:171px; left:320px; font-size:14px; width:100px">48 MW</p>
            </div>
            <script>
