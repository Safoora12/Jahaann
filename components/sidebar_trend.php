...
<body>
    ...
    <section class= "side_items"> 
        ...
        <h3 class ="diageram">Trends Section  </h3>

        <h2 class ="diageram" style = " margin-left: 10px; border: none; height:36px;" >
            <div class="toggle-button" onclick="toggleSidebar()">
                <i class="fa fa-bars"></i>
            </div>
            <p style = " margin-left: 50px;margin-top: 2px;">Trends&#160;Section</p>
        </h2>
        <a class= "a" href ='areal_view.php' ><h3 class ="diageram_below <?php if($page == 'areal_view.php'){ echo 'active';}?>">1- &nbsp; Customize Trend<i class="fa fa-ellipsis-v"  style="float: right; margin-right: 10px;"></i></h3></a>
    </section> 
    </div>
</body>
<script>
