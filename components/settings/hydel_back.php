...
$sql = "INSERT INTO hydel (name, minVolt, maxVolt, minCurrnt, maxCurrnt, minEnergy, maxEnergy, Time, refresh) VALUES ('$meter_name', $min_voltage, $max_voltage, $min_current, $max_current, $min_kW, $max_kW, NOW(), $refresh_rate)";
