...
<body>
    ...
    <section class= "side_items"> 
        ...
        <a class= "a" href ='areal_view.php' ><h3 class ="diageram_below <?php if($page == 'areal_view.php'){ echo 'active';}?>">1- &nbsp; Overview</h3></a>
        <a class= "a" href ='eui_map.php' ><h3 class ="diageram_below <?php if($page == 'eui_map.php'){ echo 'active';}?>">2- &nbsp; Regional EUI Map</h3></a>
        <a class= "a" href ='transformer.php'> <h3 class ="diageram_below <?php if($page == 'transformer.php'){ echo 'active';}?>"> 3- &nbsp; Transformer Monitoring </h3></a>
        <a class= "a" href ='wind.php'> <h3 class="diageram_below <?php if($page == 'wind.php'){ echo 'active';}?>">4- &nbsp; Wind Generation  </h3>    </a>
        <a class= "a" href ='solar_energy.php'><h3 class ="diageram_below <?php if($page == 'solar_energy.php'){ echo 'active';}?>"> 5- &nbsp; Solar Generation  </h3></a>
        <a class= "a" href ='hydel.php'><h3 class ="diageram_below <?php if($page == 'hydel.php'){ echo 'active';}?>" > 6- &nbsp; Hydel Power Generation</h3></a>
        ...
        <h3 class ="diageram_below <?php if($page == 'textile.php' || $page == 'textile_oneline.php' ){ echo 'active';}?>"  onclick="toggleSubmenu10()"> 13- &nbsp; Textile Industry  <i class="fa fa-ellipsis-v" style="float: right; margin-right: 10px;"></i>  
