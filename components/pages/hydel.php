...
<body class="body">
    ...
    <div id="main">
        ...
        <div class="map_div" style="position: relative;">
            ...
            <img class="applicationLogo" src="../images/plant.png" height="694px" style="margin-left:60px;">
            <!-- METERS -->
            ...
            <div style="position:absolute; top:42px; left:1120px;color:#0000FF;width:180px">
                ...
                <p style="padding-bottom:1px;">15 MW</p>
                <p style="padding-bottom:1px;">13.4 MW</p>
            ...
            <div style="position:absolute; top:578px; left:895px;color:black;width:180px">
            ...
            <div style="position:absolute; top:204px; left:798px;color:black;width:180px">
            
                <p style="padding-bottom:2px;">Water Level</p>
            </div>
            <div style="position:absolute;  top:204px; left:882px;color:#0000FF;width:180px">
