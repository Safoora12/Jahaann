...
<body class="body">
    ...
    <div id="main">
        ...
        <div class="map_div" style="position: relative;">
            ...
            <img class="applicationLogo" src="../images/mall.png" height="350px" width="auto" style="margin-left: 50px; margin-top:100px">
            <!-- <img class="applicationLogo" src="../images/Transformer_pic.png" height="250px" width="auto" style="position:absolute;top:230px ; left:200px "> -->
            <!-- values -->
            ...
            <div style="position:absolute; top:141px; left:600px;color:#0000FF;width:180px">
                ...
                <p style="padding-bottom:1px;">2.55 MW</p>
                <p style="padding-bottom:1px;">879 MWh</p>
            </div>
